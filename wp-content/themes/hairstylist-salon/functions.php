 ...
 */
 ...
 function hairstylist_salon_logo_resizer() {
	...
	$hairstylist_salon_theme_custom_logo_id = get_theme_mod( 'custom_logo' );
	$hairstylist_salon_theme_logo_width = get_theme_mod( 'hairstylist_salon_logo_resizer', 150 ); // Default to 200 if not set
	$hairstylist_salon_theme_logo_height = $hairstylist_salon_theme_logo_width * 0.5;

	if ( $hairstylist_salon_theme_custom_logo_id ) {
		$hairstylist_salon_theme_logo_data = wp_get_attachment_image_src( $hairstylist_salon_theme_custom_logo_id, 'full' );
		$hairstylist_salon_theme_logo_url = $hairstylist_salon_theme_logo_data[0];
		$hairstylist_salon_theme_original_width = $hairstylist_salon_theme_logo_data[1];
		$hairstylist_salon_theme_original_height = $hairstylist_salon_theme_logo_data[2];
		$hairstylist_salon_theme_aspect_ratio = $hairstylist_salon_theme_original_height / $hairstylist_salon_theme_original_width;
		$hairstylist_salon_theme_logo_height = $hairstylist_salon_theme_logo_width * $hairstylist_salon_theme_aspect_ratio;
   
	}
	$hairstylist_salon_theme_logo_size_css = '
		.custom-logo{
			height: '.esc_attr($hairstylist_salon_theme_logo_height).'px !important;
			width: '.esc_attr($hairstylist_salon_theme_logo_width).'px !important;
		}
	';
