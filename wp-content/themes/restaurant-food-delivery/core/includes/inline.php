...
$restaurant_food_delivery_custom_css = '';
    ...
    if($restaurant_food_delivery_text_transform == 'CAPITALISE'){
		...
		if($restaurant_food_delivery_menu_zoom == 'None'){
			...
			$restaurant_food_delivery_custom_css .='#main-menu ul li a:hover{';

				$restaurant_food_delivery_custom_css .='transition: all 0.3s ease-in-out !important; transform: scale(1.2) !important; color: #d31b27;';
