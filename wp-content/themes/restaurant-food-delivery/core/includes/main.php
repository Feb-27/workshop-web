        ...
        if ( ! get_option('dismissed-get_started', FALSE ) ) { ?>
			...
			<div class="restaurant-food-delivery-notice">
				...
				<div class="restaurant-food-delivery-notice-content">
					...
					<p><?php printf(__('To avail the benefits of the premium edition, kindly click on <a href="%s">More Options</a>.', 'restaurant-food-delivery'), esc_url(admin_url('themes.php?page=restaurant-food-delivery-guide-page'))); ?></p>
		...
		<div id="righty">
			<div class="postboxx donate">
				...
				<div class="insidee theme-bundle">
					<p class="offer"><?php esc_html_e('Get 80+ Perfect WordPress Theme In A Single Package at just $79."','restaurant-food-delivery'); ?></p>
					<p class="coupon"><?php esc_html_e('Get Our Theme Pack of 80+ WordPress Themes At 15% Off','restaurant-food-delivery'); ?><span class="coupon-code"><?php esc_html_e('"Bundleup15"','restaurant-food-delivery'); ?></span></p>
