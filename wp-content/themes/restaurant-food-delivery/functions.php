...
function restaurant_food_delivery_global_color() {
    ...
    $restaurant_food_delivery_theme_color_css = '';
	...
	';
    wp_add_inline_style( 'restaurant-food-delivery-style',$restaurant_food_delivery_theme_color_css );
    wp_add_inline_style( 'restaurant-food-delivery-woocommerce-css',$restaurant_food_delivery_theme_color_css );
...
if (!function_exists('restaurant_food_delivery_widgets_init')) {
	...
	function restaurant_food_delivery_widgets_init() {
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Menu Sidebar','restaurant-food-delivery'),
			'id'   => 'restaurant-food-delivery-menu-sidebar',
			'description'   => esc_html__('This sidebar will be shown in the header.', 'restaurant-food-delivery'),
...
if (!function_exists('restaurant_food_delivery_loop_columns')) {
	function restaurant_food_delivery_loop_columns() {
		$restaurant_food_delivery_columns = get_theme_mod( 'restaurant_food_delivery_per_columns', 3 );
		return $restaurant_food_delivery_columns;
	}
}

//Change number of products that are displayed per page (shop page)
add_filter( 'loop_shop_per_page', 'restaurant_food_delivery_per_page', 20 );
function restaurant_food_delivery_per_page( $restaurant_food_delivery_cols ) {
  	$restaurant_food_delivery_cols = get_theme_mod( 'restaurant_food_delivery_product_per_page', 9 );
	return $restaurant_food_delivery_cols;
}

// Add filter to modify the number of related products
add_filter( 'woocommerce_output_related_products_args', 'restaurant_food_delivery_products_args' );
function restaurant_food_delivery_products_args( $args ) {
